...
class PublicViewer extends React.Component{
	...
	_readEntries(){
		...
		axios.get(window.location.origin + '/api/project/public/entry/'+ this.props.project)
			.then((response)=>{
		...
		switch(currentEntry.type){
			...
			case 'initialize':
				return (
					<div className={currentEntry.category + ' indent' + this.state.entries[index].forms.indent}>
						Initialize 
						<input placeholder='Variable' value={this.state.entries[index].forms.name} />
					</div>
				);
			...
			case 'set':
				return (
					<div className={currentEntry.category + ' indent' + this.state.entries[index].forms.indent}>
						...
						<input placeholder='Variable' value={this.state.entries[index].forms.name} /> 
						equal to 
						<input placeholder='being assigned' value={this.state.entries[index].forms.value} />
					</div>
				);
			...
			case 'add':
				return (
					<div className={currentEntry.category + ' indent' + this.state.entries[index].forms.indent}>
						...
						and assign to
						<input placeholder='Variable' value={this.state.entries[index].forms.assignee} />
					</div>
				);
			...
			case 'read':
				return (
					<div className={currentEntry.category + ' indent' + this.state.entries[index].forms.indent}>
						Read from
						<input placeholder='Source' value={this.state.entries[index].forms.from} /> 
						to
						<input placeholder='Destination' value={this.state.entries[index].forms.to} />
					</div>
				);
